...
def draw_str(dst, target, s):
    ...
    cv.putText(dst, s, (x, y), cv.FONT_HERSHEY_PLAIN, 0.7, (255, 255, 255), lineType=cv.LINE_AA)

def draw_strApe(dst, target, s):
    x, y = target
    cv.putText(dst, s, (x+1, y+1), cv.FONT_HERSHEY_PLAIN, 0.8, (0, 0, 0), thickness = 2, lineType=cv.LINE_AA)
    cv.putText(dst, s, (x, y), cv.FONT_HERSHEY_PLAIN, 0.8, (80, 170, 250), lineType=cv.LINE_AA)    
